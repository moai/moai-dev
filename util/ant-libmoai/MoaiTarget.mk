...
LOCAL_STATIC_LIBRARIES := $(LOCAL_STATIC_JNI_LIBRARIES)  @STATIC_LIBRARIES@ libmoai-util libmoai-core libzl-core libcontrib libexpat libjson liblua libsfmt libsqlite libtinyxml libzl-vfs libzlib libcpufeatures libkissfft
