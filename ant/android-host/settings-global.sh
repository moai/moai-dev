...
#----------------------------------------------------------------#
	...
	requires=( "ouya" "google-billing" )
		
#----------------------------------------------------------------#
# list of icon files
#----------------------------------------------------------------#

	icon_ldpi="res/Icon36.png"
	icon_mdpi="res/Icon48.png"
	icon_hdpi="res/Icon72.png"
	icon_xhdpi="res/Icon96.png"
