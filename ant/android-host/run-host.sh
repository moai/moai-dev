...
#================================================================#
	...
	package=com.stirfirestudios.freedomfall.android
	package_path=src/com/stirfirestudios/freedomfall/android
	ouya_dev_id=894d8048-fd86-4804-b863-1aac42b4dde0
	out_dir="`pwd`/build"
