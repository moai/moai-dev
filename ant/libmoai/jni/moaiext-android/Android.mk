...
#================================================================#
	...
	LOCAL_CFLAGS		:= $(DISABLE_ADCOLONY) $(DISABLE_HEYZAP) $(DISABLE_BILLING) $(DISABLE_CHARTBOOST) $(DISABLE_CRITTERCISM) $(DISABLE_FACEBOOK) $(DISABLE_NOTIFICATIONS) $(DISABLE_TAPJOY) $(DISABLE_TWITTER)
	...
	LOCAL_SRC_FILES 	+= $(MY_MOAI_ROOT)/src/moai-android/MOAIHeyzapAndroid.cpp
