...
#================================================================#
	...
	MY_LOCAL_CFLAGS += -DAKU_WITH_ANDROID_FLURRY=1
	MY_INCLUDES += $(MOAI_SDK_HOME)/ant/libmoai/modules/moai-flurry.mk

	#--------------------------------------------------------------#
	# FACEBOOK

	MY_LOCAL_CFLAGS += -DAKU_WITH_ANDROID_FACEBOOK=1
	MY_INCLUDES += $(MOAI_SDK_HOME)/ant/libmoai/modules/moai-facebook.mk
	...
	MY_LOCAL_CFLAGS += -DAKU_WITH_ANDROID_GOOGLE_PLAY=1
	...
	MY_LOCAL_CFLAGS += -DAKU_WITH_ANDROID_TAPJOY=1
	MY_INCLUDES += $(MOAI_SDK_HOME)/ant/libmoai/modules/moai-tapjoy.mk
...
#================================================================#
	...
	LOCAL_STATIC_LIBRARIES := libmoai-adcolony libmoai-chartboost libmoai-facebook libmoai-flurry libmoai-google-play-services libmoai-tapjoy libmoai-twitter libmoai-vungle libmoai-box2d libmoai-http-client libmoai-luaext libmoai-untz libmoai-sim libmoai-crypto libmoai-util libmoai-core libzl-gfx libzl-crypto libzl-core libbox2d libuntz libvorbis libogg libcontrib libexpat libjson liblua libpvr libsfmt libsqlite libtinyxml libfreetype libjpg libpng libtess libcurl libcares libssl libcrypto-a libcrypto-b libcrypto-c libcrypto-d libzl-vfs libzlib
