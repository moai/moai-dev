...
xcodebuild -configuration Release -workspace libmoai.xcodeproj/project.xcworkspace -scheme libmoai-ios-chartboost -sdk iphonesimulator clean CONFIGURATION_BUILD_DIR=/tmp/ios/beta/libmoai/libmoai-ios-chartboost/iphonesimulator/Release
...
xcodebuild -configuration Release -workspace libmoai.xcodeproj/project.xcworkspace -scheme libmoai-ios-chartboost -sdk iphoneos clean CONFIGURATION_BUILD_DIR=/tmp/ios/beta/libmoai/libmoai-ios-chartboost/iphoneos/Release
