...
static TJCVGView *sharedTJCVGView_ = nil;
...
+ (TJCVGView*) sharedTJCVGView
{
	if (!sharedTJCVGView_) 
	{
		sharedTJCVGView_ = [[super alloc] init];
	}
	return sharedTJCVGView_;
}
...
{	
	...
	[self setViewColor:[[TJCViewCommons sharedObject] getUserDefinedColor]];
...
-(IBAction)dismissView
{
	...
	[self performSelector:@selector(removeView) withObject:nil afterDelay:[[TJCViewCommons sharedObject]getTransitionDelay]];
}
