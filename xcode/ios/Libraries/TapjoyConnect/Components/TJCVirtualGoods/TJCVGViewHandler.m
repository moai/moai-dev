...
- (UIView*)showVirtualGoodsWithFrame:(CGRect)frame
{
	...
	[[TJCVGView sharedTJCVGView] initWithFrame:frame];
...
- (void)showVirtualGoodsWithViewController:(UIViewController*)viewController
{
	...
	[[TJCVGView sharedTJCVGView] initWithFrame:viewController.view.bounds];
...
- (UIView*)getVirtualGoodsWithTab:(int)tabIndex
{
	...
	[[TJCVGView sharedTJCVGView] initWithFrame:[[UIScreen mainScreen]bounds]];
...
- (NSMutableArray*)getPurchasedVGStoreItems
{
	...
	return [[TJCLocalPurchasedItems sharedInstance] getPurchasedVGStoreItemsArray];
}


- (NSMutableArray*)getAllLocalVGStoreItems
{
	return [[TJCLocalPurchasedItems sharedInstance] getVGStoreItemsArray];
}
