...
for config in $configurations; do
	...
	xcodebuild -configuration $config -project MoaiSample.xcodeproj -scheme moai -sdk macosx build CONFIGURATION_BUILD_DIR=/tmp/$job/osx/MoaiSample/moai/macosx/$config
