...
struct b2Vec2
{
	...
	b2Vec2(float32 xx, float32 yy) : x(xx), y(yy) {}
...
struct b2Vec3
{
	...
	/// Construct using coordinates.
	b2Vec3(float32 xx, float32 yy, float32 zz) : x(xx), y(yy), z(zz) {}
...
struct b2Transform
{
	...
	b2Transform(const b2Vec2& positionp, const b2Mat22& RR) : position(positionp), R(RR) {}
