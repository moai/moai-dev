 ...
 */
static void drawSolidTetrahedron(void)         { fprintf(stderr, "drawSolidTetrahedron\n"); glutSolidTetrahedron ();                      }
...
static const entry table [] =
{
    ...
    //ENTRY (Teapot), // No nurbs support in GLS3D yet!
    ENTRY (Torus),
    ENTRY (Sphere),
    ENTRY (Cone),
    ENTRY (Cylinder),
...
{
    glutInit(&argc, argv);
    glutInitErrorFunc(fgError);
    glutInitWarningFunc(fgWarning);
