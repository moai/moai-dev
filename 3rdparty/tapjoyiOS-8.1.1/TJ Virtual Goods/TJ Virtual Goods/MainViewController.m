...
{
	// Notify the Tapjoy controlled views that an orientation change just occured. 
	// This is essential for certain views to orient correctly.
	[TapjoyConnect updateViewsWithOrientation:fromInterfaceOrientation];
}
