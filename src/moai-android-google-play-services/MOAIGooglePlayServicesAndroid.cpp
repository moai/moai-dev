...
int MOAIGooglePlayServicesAndroid::_connect ( lua_State* L ) {
    ...
    if ( playserv == NULL ) {
		...
		ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find java class %s", "com/moaisdk/googleplayservices/MoaiGooglePlayServices" );
    } else {

    	jmethodID connect = env->GetStaticMethodID ( playserv, "connect", "()Z" );
   		if ( connect == NULL ) {

			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "connect" );
		} else {
    ...
    if ( playserv == NULL ) {
    	...
    	jmethodID isConnected = env->GetStaticMethodID ( playserv, "isConnected", "()Z" );
   		if ( isConnected == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "isConnected" );
		} else {
...
int MOAIGooglePlayServicesAndroid::_showAchievements ( lua_State* L ) {
    ...
    if ( playserv == NULL ) {
		...
		ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find java class %s", "ccom/moaisdk/googleplayservices/MoaiGooglePlayServices" );
    } else {

    	jmethodID showAchievements = env->GetStaticMethodID ( playserv, "showAchievements", "()V" );
   		if ( showAchievements == NULL ) {

			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "showAchievements" );
		} else {
    ...
    if ( playserv == NULL ) {
    	...
    	jmethodID showLeaderboard = env->GetStaticMethodID ( playserv, "showLeaderboard", "(Ljava/lang/String;)V" );
   		if ( showLeaderboard == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "showLeaderboard" );
		} else {
    ...
    if ( playserv == NULL ) {
    	...
    	jmethodID submitScore = env->GetStaticMethodID ( playserv, "submitScore", "(Ljava/lang/String;J)V" );
   		if ( submitScore == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "submitScore" );
		} else {
    ...
    if ( playserv == NULL ) {
    	...
    	jmethodID unlockAchievement = env->GetStaticMethodID ( playserv, "unlockAchievement", "(Ljava/lang/String;)V" );
   		if ( unlockAchievement == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAIGooglePlayServicesAndroid: Unable to find static java method %s", "unlockAchievement" );
		} else {
