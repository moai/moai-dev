...
#include <moaiext-android/MOAITwitterAndroid.h>
...
int MOAITwitterAndroid::_init ( lua_State* L ) {
    ...
    if ( twitter == NULL ) {
		...
		USLog::Print ( "MOAITwitterAndroid: Unable to find java class %s", "com/ziplinegames/moai/MoaiTwitter" );
    } else {

    	jmethodID init = env->GetStaticMethodID ( twitter, "init", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V" );
   		if ( init == NULL ) {

			USLog::Print ( "MOAITwitterAndroid: Unable to find static java method %s", "init" );
		} else {
...
int MOAITwitterAndroid::_login ( lua_State *L ) {
    ...
    if ( twitter == NULL ) {
    	...
    	if ( login == NULL ) {
			...
			USLog::Print ( "MOAITwitterAndroid: Unable to find static java method %s", "login" );
    	} else {
...
int MOAITwitterAndroid::_isLoggedIn ( lua_State *L ) {
    ...
    if ( twitter == NULL ) {
    	...
    	if ( isLoggedIn  == NULL ) {
			...
			USLog::Print ( "MOAITwitterAndroid: Unable to find static java method %s", "isLoggedIn" );
    	} else {
    ...
    if ( twitter == NULL ) {
    	...
    	jmethodID setAccessToken = env->GetStaticMethodID ( twitter, "setAccessToken", "(Ljava/lang/String;Ljava/lang/String;)V" );
   		if ( setAccessToken == NULL ) {
			...
			USLog::Print ( "MOAITwitterAndroid: Unable to find static java method %s", "setAccessToken" );
		} else {
    ...
    if ( twitter == NULL ) {
    	...
    	jmethodID sendTweet = env->GetStaticMethodID ( twitter, "sendTweet", "(Ljava/lang/String;)V" );
   		if ( sendTweet == NULL ) {
			...
			USLog::Print ( "MOAITwitterAndroid: Unable to find static java method %s", "sendTweet" );
		} else {
