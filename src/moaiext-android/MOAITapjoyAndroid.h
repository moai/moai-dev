...
/**	@name	MOAITapjoyAndroid
	...
	@const	TAPJOY_VIDEO_AD_ERROR		Event code for Tapjoy video ad errors.
	@const	TAPJOY_VIDEO_AD_READY		Event code for Tapjoy video ad availability.
