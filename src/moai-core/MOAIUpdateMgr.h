...
#ifndef	MOAIUPDATEMGR_H
#define	MOAIUPDATEMGR_H
...
public:
	...
	//----------------------------------------------------------------//
	virtual void	MOAIUpdateMgr_DidResume		( double skip ) = 0;
	virtual void	MOAIUpdateMgr_WillStep		( double step ) = 0;
	virtual void	MOAIUpdateMgr_WillUpdate	() = 0;
...
public:
	...
	DECL_LUA_SINGLETON ( MOAIUpdateMgr )
