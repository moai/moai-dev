...
\n
	...
	@param self (in)
*/
int MOAISpriteLibrary::_bind ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "U" )
...
*/
int MOAISpriteLibrary::_enumSprites ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNNNN" )
...
*/
int MOAISpriteLibrary::_enumUVTiles ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNNNNNN" )
...
\n
	...
	@param self (in)
*/
int MOAISpriteLibrary::_releaseTexture ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "U" )
...
*/
int MOAISpriteLibrary::_reservePrims ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UN" )
...
*/
int MOAISpriteLibrary::_reserveQuads ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UN" )
...
*/
int MOAISpriteLibrary::_reserveSprites ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UN" )
...
*/
int MOAISpriteLibrary::_reserveUVRects ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UN" )
...
*/
int MOAISpriteLibrary::_scaleCoords ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNN" )
...
\n
	...
	@param yScale (in) The vertical scaling value.
*/
int MOAISpriteLibrary::_scaleUVCoords ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNN" )
...
*/
int MOAISpriteLibrary::_setPrim ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNN" )
...
\n
	...
	@param y3 (in)
*/
int MOAISpriteLibrary::_setQuad ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNNNNNNNN" )
...
*/
int MOAISpriteLibrary::_setRect ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNNNN" )
...
*/
int MOAISpriteLibrary::_setSprite ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNN" )
...
*/
int MOAISpriteLibrary::_setTexture ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "U" )

	MOAITexture* texture = MOAITexture::AffirmTexture ( state, 2 );
...
*/
int MOAISpriteLibrary::_setUVRect ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UNNNNN" )
...
\n
	...
	@param y (out)
*/
int MOAISpriteLibrary::_setUVRectTransform ( lua_State* L ) {
	LUA_SETUP ( MOAISpriteLibrary, "UN" )
...
//----------------------------------------------------------------//
bool MOAISpriteLibrary::Contains ( u32 idx, const USVec2D& vec ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::Draw ( MOAIDrawingMtx2D& transform, u32 idx ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::Draw ( MOAIDrawingMtx2D& transform, MOAIGrid& grid, USTileCoord& c0, USTileCoord& c1 ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::Draw ( u32 idx, float xOff, float yOff, float xScale, float yScale ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::EnumSprites ( u32 idx, u32 basePrimID, u32 uvRectID, u32 screenRectID, u32 total ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::EnumUVTiles ( u32 idx, u32 width, u32 height, float xStep, float yStep ) {
...
//----------------------------------------------------------------//
USRect MOAISpriteLibrary::GetBounds ( u32 idx ) {
...
//----------------------------------------------------------------//
MOAISpriteLibrary::MOAISpriteLibrary () {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::RegisterLuaClass ( USLuaState& state ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::RegisterLuaFuncs ( USLuaState& state ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::ReleaseTexture () {

	this->mTexture->USTexture::Release ();
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::ReservePrims ( u32 total ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::ReserveQuads ( u32 total ) {

	this->mQuads.Init ( total );
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::ReserveSprites ( u32 total ) {

	this->mSprites.Init ( total );
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::ReserveUVRects ( u32 total ) {

	this->mUVRects.Init ( total );
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::ScaleScreenCoords ( float xScale, float yScale ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::ScaleUVCoords ( float xScale, float yScale ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetPrim ( u32 idx, u32 uvRectID, u32 screenRectID ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetQuad ( u32 idx, USQuad& quad ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetRect ( u32 idx, USRect& rect ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetSprite ( u32 idx, u32 basePrimID, u32 totalPrims ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetTexture ( cc8* filename ) {

	if ( !USFileSys::CheckFileExists ( filename )) return;
	
	this->mTexture = new MOAITexture ();
	this->mTexture->Init ( filename, USImageTransform::TRUECOLOR );
	this->mTexture->SetFilter ( GL_LINEAR, GL_LINEAR );
	this->mTexture->SetWrap ( GL_REPEAT );
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::SetTexture ( MOAITexture* texture ) {

	this->mTexture = texture;
}

//----------------------------------------------------------------//
void MOAISpriteLibrary::SetUVRect ( u32 idx, USRect& rect ) {
...
//----------------------------------------------------------------//
void MOAISpriteLibrary::SetUVRectTransform ( u32 idx, u32 transform ) {
...
//----------------------------------------------------------------//
STLString MOAISpriteLibrary::ToString () {
