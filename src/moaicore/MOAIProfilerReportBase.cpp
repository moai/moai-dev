...
//----------------------------------------------------------------//
MOAIProfilerEntryBase* MOAIProfilerReportBase::_CreateEntry ( MOAIProfilerEntryBase* parent, const USHashedString& name ) {
...
//----------------------------------------------------------------//
void MOAIProfilerReportBase::EnterScope ( const USHashedString& name ) {
...
//----------------------------------------------------------------//
MOAIProfilerReportBase::MOAIProfilerReportBase ( const USHashedString& name, const u32 maxEntryPoolSize ) :
	mName( name ),
	mRootEntry ( 0 ),
	mMetaRootEntry ( 0 ),
	mCurrentEntry ( 0 ),
