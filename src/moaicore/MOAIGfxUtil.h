...
#ifndef	MOAIGFXUTIL_H
#define	MOAIGFXUTIL_H
...
public:
	...
	static void			BeginDrawing			( MOAIViewport& viewport, USAffine2D& camera );
	...
	static void			GetViewQuad				( USQuad& quad );
	static void			GetViewRect				( USRect& rect );
	void				GetWorldToModelMtx		( USAffine2D& worldToModel );
	...
	static void			SetScreenSpace			( MOAIViewport& viewport );
