...
//----------------------------------------------------------------//
MOAIProfilerReport::MOAIProfilerReport ( const USHashedString& name ) :
...
//----------------------------------------------------------------//
MOAIProfilerEntryBase* MOAIProfilerReport::_OnCreateNewEntry ( MOAIProfilerEntryBase* parent, const USHashedString& name ) {
