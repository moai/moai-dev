...
/**	@name	getJointSpeed
	...
	@in		MOAIBox2DLineJoint self
	@out	number jointSpeed
*/
int MOAIBox2DLineJoint::_getJointSpeed ( lua_State* L ) {
...
*/
int MOAIBox2DLineJoint::_getLowerLimit ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIBox2DLineJoint, "U" )
	float unitsToMeters = self->GetUnitsToMeters ();
...
*/
int MOAIBox2DLineJoint::_getMotorSpeed ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIBox2DLineJoint, "U" )
	float unitsToMeters = self->GetUnitsToMeters ();
...
*/
int MOAIBox2DLineJoint::_getUpperLimit ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIBox2DLineJoint, "U" )
	float unitsToMeters = self->GetUnitsToMeters ();
...
/**	@name	setMaxMotorForce
	...
	@out	nil
*/
int MOAIBox2DLineJoint::_setMaxMotorForce ( lua_State* L ) {
	MOAI_LUA_SETUP ( MOAIBox2DLineJoint, "U" )
	float unitsToMeters = self->GetUnitsToMeters ();
...
//----------------------------------------------------------------//
MOAIBox2DLineJoint::MOAIBox2DLineJoint () {
...
//----------------------------------------------------------------//
STLString MOAIBox2DLineJoint::ToString () {
