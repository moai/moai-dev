...
private:
    ...
    static int      _getSourcePositionX                 ( lua_State* L );
    static int      _setSourcePositionX                 ( lua_State* L );
    static int      _getSourcePositionY                 ( lua_State* L );
    static int      _setSourcePositionY                 ( lua_State* L );
