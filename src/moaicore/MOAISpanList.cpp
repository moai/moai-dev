...
//----------------------------------------------------------------//
MOAISpan* MOAISpanList::Alloc ( size_t size ) {

	MOAISpan* span = this->mHead;
...
//----------------------------------------------------------------//
void MOAISpanList::Expand ( size_t size ) {
