...
private:
	...
	typedef ZLFactory < STLString, MOAITest >::iterator Iterator;
	ZLFactory < STLString, MOAITest > mFactory;
	...
	void			Finish					();
	static void		ParseKeywords			( ZLStream& stream, STLSet < STLString >& keywords );
