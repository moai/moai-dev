...
//----------------------------------------------------------------//
void MOAITestMgr::ParseKeywords ( ZLStream& stream, STLSet < STLString >& keywords ) {
...
void MOAITestMgr::SetResultsFile ( cc8* filename ) {
	...
	this->mResultsFilename = ZLFileSys::GetAbsoluteFilePath ( filename );
}

//----------------------------------------------------------------//
void MOAITestMgr::SetXmlResultsFile ( cc8* filename ) {

	this->mXmlResultsFilename = ZLFileSys::GetAbsoluteFilePath ( filename );
