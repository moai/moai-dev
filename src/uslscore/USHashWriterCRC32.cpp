...
//----------------------------------------------------------------//
void USHashWriterCRC32::FinalizeHash () {
}
...
//----------------------------------------------------------------//
size_t USHashWriterCRC32::GetHashSize () {

	return 4;
}

//----------------------------------------------------------------//
void USHashWriterCRC32::HashBytes ( const void* buffer, size_t size ) {
	...
	switch ( this->mAlgorithm ) {
		...
		case CRC32B: {
			this->mSum = (u32) crc32 ( this->mSum, ( Bytef* )buffer, (u32) size );
			break;
		}
	}
...
//----------------------------------------------------------------//
void USHashWriterCRC32::InitHash () {
...
//----------------------------------------------------------------//
void USHashWriterCRC32::SetAlgorithm ( u32 algorithm ) {
	this->mAlgorithm = algorithm;
}

//----------------------------------------------------------------//
USHashWriterCRC32::USHashWriterCRC32 () :
	mAlgorithm ( CRC32 ) {
}
