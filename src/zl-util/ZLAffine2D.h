...
public:
	...
	//----------------------------------------------------------------//
	ZLMetaVec2D < TYPE > GetHeading () const {

		ZLMetaVec2D < TYPE > heading;
	...
	//----------------------------------------------------------------//
	ZLMetaVec2D < TYPE > GetStretch () const {

		ZLMetaVec2D < TYPE > stretch;
		ZLMetaVec2D < TYPE > axis;
	...
	bool Inverse () {
		...
		ZLMetaAffine2D < TYPE > temp = *this;
		return Inverse ( temp );
	}

	//----------------------------------------------------------------//
	bool Inverse ( const ZLMetaAffine2D < TYPE >& mtx ) {
	...
	//----------------------------------------------------------------//
	bool IsSame ( const ZLMetaAffine2D < TYPE >& compare ) const {
	...
	//----------------------------------------------------------------//
	void Multiply ( const ZLMetaAffine2D < TYPE >& mtx2, const ZLMetaAffine2D < TYPE >& mtx1 ) {
	...
	//----------------------------------------------------------------//
	void Prepend ( const ZLMetaAffine2D < TYPE >& mtx ) {
