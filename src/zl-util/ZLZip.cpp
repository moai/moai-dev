...
//----------------------------------------------------------------//
int ZLZip::Deflate ( const void* buffer, size_t size, ZLLeanArray < u8 >& result, int level ) {

	ZLMemStream outStream;
	
	ZLByteStream inStream;
	inStream.SetBuffer (( void* )buffer, size );
	inStream.SetLength ( size );
	
	int r = ZLZip::Deflate ( inStream, outStream, level );
...
//----------------------------------------------------------------//
int ZLZip::Deflate ( ZLStream& source, ZLStream& dest, int level ) {
...
//----------------------------------------------------------------//
int ZLZip::Inflate ( const void* buffer, size_t size, ZLLeanArray < u8 >& result ) {
	...
	int r = ZLZip::Inflate ( inStream, outStream );
...
//----------------------------------------------------------------//
int ZLZip::Inflate ( ZLStream& source, ZLStream& dest ) {
