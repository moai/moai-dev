...
public:
	...
	//----------------------------------------------------------------//
	static ZLGfxEnum::_ Remap ( MOAIGfxTopologyEnum::_ value ) {
	
		switch ( value ) {
			case MOAIGfxTopologyEnum::LINE_LIST:					return ZLGfxEnum::PRIM_LINES;
			case MOAIGfxTopologyEnum::LINE_LOOP:					return ZLGfxEnum::PRIM_LINE_LOOP;
			case MOAIGfxTopologyEnum::LINE_STRIP:					return ZLGfxEnum::PRIM_LINE_STRIP;
			case MOAIGfxTopologyEnum::POINT_LIST:					return ZLGfxEnum::PRIM_POINTS;
			case MOAIGfxTopologyEnum::TRIANGLE_FAN:					return ZLGfxEnum::PRIM_TRIANGLE_FAN;
			case MOAIGfxTopologyEnum::TRIANGLE_LIST:				return ZLGfxEnum::PRIM_TRIANGLES;
			case MOAIGfxTopologyEnum::TRIANGLE_STRIP:				return ZLGfxEnum::PRIM_TRIANGLE_STRIP;
		}
		assert ( false );
		return ZLGfxEnum::NONE;
	}
