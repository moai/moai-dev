...
public:
	...
	//----------------------------------------------------------------//
	static ZGLEnum Remap ( MOAITopology::Type value ) {
	
		switch ( value ) {
			case MOAITopology::LINE_LIST:						return ZGL_PRIM_LINES;
			case MOAITopology::LINE_LOOP:						return ZGL_PRIM_LINE_LOOP;
			case MOAITopology::LINE_STRIP:						return ZGL_PRIM_LINE_STRIP;
			case MOAITopology::POINT_LIST:						return ZGL_PRIM_POINTS;
			case MOAITopology::TRIANGLE_FAN:					return ZGL_PRIM_TRIANGLE_FAN;
			case MOAITopology::TRIANGLE_LIST:					return ZGL_PRIM_TRIANGLES;
			case MOAITopology::TRIANGLE_STRIP:					return ZGL_PRIM_TRIANGLE_STRIP;
		}
		assert ( false );
		return ZGL_NONE;
	}
