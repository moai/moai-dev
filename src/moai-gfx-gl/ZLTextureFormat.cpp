...
//----------------------------------------------------------------//
void ZLTextureFormat::SetGLTexture ( MOAITextureGL& texture, const ZLGfxHandle& glTexture, ZLGfxEnum::Type internalFormat, ZLGfxEnum::Type pixelType, size_t textureSize ) {
