...
//----------------------------------------------------------------//
void MOAITextureBaseGL::CheckFilterModes ( int min, int mag ) {
	UNUSED ( min );
	UNUSED ( mag );
...
//----------------------------------------------------------------//
void MOAITextureBaseGL::CleanupOnError () {
...
//----------------------------------------------------------------//
bool MOAITextureBaseGL::CreateTextureFromImage ( ZLImage& srcImage ) {
...
MOAITextureBaseGL::MOAITextureBaseGL () :
	...
	RTTI_BEGIN
		RTTI_EXTEND ( MOAIAbstractTexture )
...
void MOAITextureBaseGL::RegisterLuaClass ( MOAILuaState& state ) {
	MOAIAbstractTexture::RegisterLuaClass ( state );
...
void MOAITextureBaseGL::RegisterLuaFuncs ( MOAILuaState& state ) {
	MOAIAbstractTexture::RegisterLuaFuncs ( state );
...
//----------------------------------------------------------------//
void MOAITextureBaseGL::SetFilter ( int filter ) {

	this->SetFilter ( filter, filter );
}

//----------------------------------------------------------------//
void MOAITextureBaseGL::SetFilter ( int min, int mag ) {
...
//----------------------------------------------------------------//
void MOAITextureBaseGL::SetGLTexture ( const ZLGfxHandle& glTexture, int internalFormat, int pixelType, size_t textureSize ) {
...
//----------------------------------------------------------------//
void MOAITextureBaseGL::SetWrap ( int wrap ) {
...
//----------------------------------------------------------------//
bool MOAITextureBaseGL::ShouldGenerateMipmaps () {
...
//----------------------------------------------------------------//
bool MOAITextureBaseGL::UpdateTextureFromImage ( ZLImage& image, ZLIntRect rect ) {
...
//----------------------------------------------------------------//
bool MOAITextureBaseGL::ZLAbstractGfxResource_OnCPUCreate () {

	return true;
}

//----------------------------------------------------------------//
void MOAITextureBaseGL::ZLAbstractGfxResource_OnCPUDestroy () {
}

//----------------------------------------------------------------//
void MOAITextureBaseGL::ZLAbstractGfxResource_OnGPUBind () {

	this->mGfxMgr->GetDrawingAPI ().BindTexture ( this->mGLTexture );
}

//----------------------------------------------------------------//
void MOAITextureBaseGL::ZLAbstractGfxResource_OnGPUDeleteOrDiscard ( bool shouldDelete ) {
...
//----------------------------------------------------------------//
void MOAITextureBaseGL::ZLAbstractGfxResource_OnGPUUnbind () {

	this->mGfxMgr->GetDrawingAPI ().BindTexture ( ZLGfxResource::UNBIND );
}

//----------------------------------------------------------------//
bool MOAITextureBaseGL::ZLAbstractGfxResource_OnGPUUpdate () {
...
//----------------------------------------------------------------//
u32 MOAITextureBaseGL::ZLAbstractTexture_GetHeight () const {

	return this->mHeight;
}

//----------------------------------------------------------------//
u32 MOAITextureBaseGL::ZLAbstractTexture_GetWidth () const {

	return this->mWidth;
}

//----------------------------------------------------------------//
void MOAITextureBaseGL::ZLGfxListener_OnGfxEvent ( u32 event, void* userdata ) {
