...
#define SUPPORT_FULL_3D_SOUNDS 0
    ...
    public:
        ...
        void SetPosition( const USVec3D& vPosition, const USVec3D& vVelocity = USVec3D(0.f, 0.f, 0.f), const USVec3D& vForward = USVec3D(0.f, 0.f, 1.f));
        void SetOrientation( const USVec3D& vForward, const USVec3D& vUp = USVec3D( 0.f, 1.f, 0.f ) );
        ...
        const USVec3D& GetPosition() const                         { return m_vPosition; }    
    ...
    private:
        ...
        void SetPositionInternal(const USVec3D& vPos, const USVec3D& vVelocity, const USVec3D& vForward);
    ...
    inline
        void EventInstance::SetPosition(const USVec3D& vPosition, const USVec3D& vVelocity, const USVec3D& vForward)
    {
        if( GetFlag(kSIF_3D) )
        {    
