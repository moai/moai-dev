...
//----------------------------------------------------------------//
size_t ZIPFSZipStream::Inflate ( void* dest, size_t size, void* buffer, size_t bufferSize ) {

	int result;
	FILE* file = this->mFile;
	z_stream* stream = &this->mStream;
    ZIPFSZipFileEntry* entry = this->mEntry;
    size_t totalRead = 0;
    size_t totalOut = 0;
...
//----------------------------------------------------------------//
int ZIPFSZipStream::InitBuffers () {
...
//----------------------------------------------------------------//
int ZIPFSZipStream::IsAtEnd () {

	return this->mUncompressedCursor >= this->mEntry->mUncompressedSize ? 1 : 0;	
}

//----------------------------------------------------------------//
ZIPFSZipStream* ZIPFSZipStream::Open ( ZIPFSZipArchive* archive, const char* entryname ) {

	int result;
	FILE* file = 0;
	ZIPFSZipFileEntry* entry;
	ZIPFSZipFileHeader fileHeader;
...
//----------------------------------------------------------------//
size_t ZIPFSZipStream::Read ( void* buffer, size_t size ) {
...
//----------------------------------------------------------------//
int ZIPFSZipStream::ResetZipStream () {
...
//----------------------------------------------------------------//
int ZIPFSZipStream::Seek ( long int offset, int origin ) {
...
//----------------------------------------------------------------//
size_t ZIPFSZipStream::Tell () {

	return this->mUncompressedCursor;
}

//----------------------------------------------------------------//
int ZIPFSZipStream::UnGetChar ( char c ) {
