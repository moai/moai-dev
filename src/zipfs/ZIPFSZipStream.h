...
#ifndef ZIPFSZIPSTREAM_H
#define ZIPFSZIPSTREAM_H
...
public:
	...
	void						Close				();
	int							IsAtEnd				();
	static ZIPFSZipStream*		Open				( ZIPFSZipArchive* archive, const char* entryname );
