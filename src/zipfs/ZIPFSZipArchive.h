...
#ifndef ZIPFSZIPARCHIVE_H
#define ZIPFSZIPARCHIVE_H

//================================================================//
// ZIPFSZipArchiveHeader
//================================================================//
class ZIPFSZipArchiveHeader {
public:
...
public:
	...
	friend class ZIPFSZipArchive;

	std::string			mName;
	
	ZIPFSZipFileDir*	mNext;
	ZIPFSZipFileDir*	mChildDirs;
	ZIPFSZipFileEntry*	mChildFiles;

	//----------------------------------------------------------------//
	ZIPFSZipFileDir*	AffirmSubDir		( const char* name, size_t len );
...
// ZIPFSZipArchive
//================================================================//
class ZIPFSZipArchive {
public:

	friend class ZIPFSZipStream;

	std::string			mFilename;
    ZIPFSZipFileDir*	mRoot;

	//----------------------------------------------------------------//
	void					AddEntry		( ZIPFSZipEntryHeader* header, const char* name );

public:

	//----------------------------------------------------------------//
	void					Delete				();
	ZIPFSZipFileDir*		FindDir				( char const* path );
	ZIPFSZipFileEntry*		FindEntry			( char const* filename );
