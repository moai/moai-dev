...
//----------------------------------------------------------------//
void MOAIGfxStateGPUCache::FlushTexture ( ZLIndex textureUnit, MOAITextureBase* texture ) {
...
//----------------------------------------------------------------//
bool MOAIGfxStateGPUCache::SetTexture ( MOAITextureBase* texture, ZLIndex textureUnit ) {
