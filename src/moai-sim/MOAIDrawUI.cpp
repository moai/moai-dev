...
//----------------------------------------------------------------//
void MOAIDrawUI::BeginDrawString ( float scale, MOAIFont& font, float fontSize, float shadowOffsetX, float shadowOffsetY ) {
...
//----------------------------------------------------------------//
void MOAIDrawUI::DrawString ( cc8* text, float x, float y, float width, float height ) {
...
//----------------------------------------------------------------//
void MOAIDrawUI::DrawString	( cc8* text, float x, float y, float scale, MOAIFont& font, float fontSize, float shadowOffsetX, float shadowOffsetY, float width, float height ) {
