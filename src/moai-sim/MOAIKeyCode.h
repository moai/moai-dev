...
namespace MOAIKeyCodes {
	const int NONCHAR_KEY_OFFSET = 0x100;
	...
	enum {
		BACKSPACE			= NONCHAR_KEY_OFFSET + 8,		// VK_BACK
		TAB					= NONCHAR_KEY_OFFSET + 9,		// VK_TAB
		RETURN				= NONCHAR_KEY_OFFSET + 13,		// VK_RETURN
		SHIFT				= NONCHAR_KEY_OFFSET + 16,		// VK_SHIFT
		CONTROL				= NONCHAR_KEY_OFFSET + 17,		// VK_CONTROL
		ALT					= NONCHAR_KEY_OFFSET + 18,		// VK_MENU
		PAUSE				= NONCHAR_KEY_OFFSET + 19,		// VK_PAUSE
		CAPS_LOCK			= NONCHAR_KEY_OFFSET + 20,		// VK_CAPITAL
		ESCAPE				= NONCHAR_KEY_OFFSET + 27,		// VK_ESCAPE
		SPACE				= ' ',							// VK_SPACE
		PAGE_UP				= NONCHAR_KEY_OFFSET + 33,		// VK_PRIOR
		PAGE_DOWN			= NONCHAR_KEY_OFFSET + 34,		// VK_NEXT
		END					= NONCHAR_KEY_OFFSET + 35,		// VK_END
		HOME				= NONCHAR_KEY_OFFSET + 36,		// VK_HOME
		LEFT				= NONCHAR_KEY_OFFSET + 37,		// VK_LEFT
		UP					= NONCHAR_KEY_OFFSET + 38,		// VK_UP
		RIGHT				= NONCHAR_KEY_OFFSET + 39,		// VK_RIGHT
		DOWN				= NONCHAR_KEY_OFFSET + 40,		// VK_DOWN
		PRINT_SCREEN		= NONCHAR_KEY_OFFSET + 44,		// VK_SNAPSHOT
		INSERT				= NONCHAR_KEY_OFFSET + 45,		// VK_INSERT
		DELETE				= NONCHAR_KEY_OFFSET + 46,		// VK_DELETE
		DIGIT_0				= '0',
		DIGIT_1				= '1',
		DIGIT_2				= '2',
		DIGIT_3				= '3',
		...
		Y					= 'y',
		Z					= 'z',
		GUI					= NONCHAR_KEY_OFFSET + 91,		// VK_LWIN
		APPLICATION			= NONCHAR_KEY_OFFSET + 93,		// VK_APPS
		NUM_0				= NONCHAR_KEY_OFFSET + 96,		// VK_NUMPAD0
		NUM_1				= NONCHAR_KEY_OFFSET + 97,		// VK_NUMPAD1
		NUM_2				= NONCHAR_KEY_OFFSET + 98,		// VK_NUMPAD2
		NUM_3				= NONCHAR_KEY_OFFSET + 99,		// VK_NUMPAD3
		NUM_4				= NONCHAR_KEY_OFFSET + 100,		// VK_NUMPAD4
		NUM_5				= NONCHAR_KEY_OFFSET + 101,		// VK_NUMPAD5
		NUM_6				= NONCHAR_KEY_OFFSET + 102,		// VK_NUMPAD6
		NUM_7				= NONCHAR_KEY_OFFSET + 103,		// VK_NUMPAD7
		NUM_8				= NONCHAR_KEY_OFFSET + 104,		// VK_NUMPAD8
		NUM_9				= NONCHAR_KEY_OFFSET + 105,		// VK_NUMPAD9
		NUM_MULTIPLY		= NONCHAR_KEY_OFFSET + 106,		// VK_MULTIPLY
		NUM_PLUS			= NONCHAR_KEY_OFFSET + 107,		// VK_ADD
		NUM_MINUS			= NONCHAR_KEY_OFFSET + 109,		// VK_SUBTRACT
		NUM_DECIMAL			= NONCHAR_KEY_OFFSET + 110,		// VK_DECIMAL
		NUM_DIVIDE			= NONCHAR_KEY_OFFSET + 111,		// VK_DIVIDE
		F1					= NONCHAR_KEY_OFFSET + 112,		// VK_F1
		F2					= NONCHAR_KEY_OFFSET + 113,		// VK_F2
		F3					= NONCHAR_KEY_OFFSET + 114,		// VK_F3
		F4					= NONCHAR_KEY_OFFSET + 115,		// VK_F4
		F5					= NONCHAR_KEY_OFFSET + 116,		// VK_F5
		F6					= NONCHAR_KEY_OFFSET + 117,		// VK_F6
		F7					= NONCHAR_KEY_OFFSET + 118,		// VK_F7
		F8					= NONCHAR_KEY_OFFSET + 119,		// VK_F8
		F9					= NONCHAR_KEY_OFFSET + 120,		// VK_F9
		F10					= NONCHAR_KEY_OFFSET + 121,		// VK_F10
		F11					= NONCHAR_KEY_OFFSET + 122,		// VK_F11
		F12					= NONCHAR_KEY_OFFSET + 123,		// VK_F12
		NUM_LOCK			= NONCHAR_KEY_OFFSET + 144,		// VK_NUMLOCK
		SCROLL_LOCK			= NONCHAR_KEY_OFFSET + 145,		// VK_SCROLL
		OEM_1				= ';',							// VK_OEM_1
		...
		OEM_6				= ']',							// VK_OEM_6
		OEM_7				= '\'',							// VK_OEM_7
		OEM_8				= NONCHAR_KEY_OFFSET + 223,		// VK_OEM_8
		OEM_102				= NONCHAR_KEY_OFFSET + 226,		// VK_OEM_102

		TOTAL				= NONCHAR_KEY_OFFSET + 0x100,
		INVALID				= TOTAL
	};
};
