...
public:
	...
	void				PushCombo					();
	void				PushEllipse					( real x, real y, real xRad, real yRad );
	void				PushPoly					( ZLVec2D* vertices, u32 total, bool closed );
	void				PushRect					( real xMin, real yMin, real xMax, real yMax );
	void				PushRotate					( real x, real y, real r );
	void				PushScale					( real x, real y );
	void				PushSkew					( real yx, real xy );
	void				PushTransform				( const ZLAffine2D& transform );
	void				PushTransform				( real a, real b, real c, real d, real tx, real ty );
	void				PushTranslate				( real x, real y);
	void				PushVertex					( real x, real y );
