...
public:
	...
	enum {
		DEBUG_DRAW_TEXT_BOX,
		DEBUG_DRAW_TEXT_BOX_BASELINES,
		DEBUG_DRAW_TEXT_BOX_GLYPH_BOUNDS,
		DEBUG_DRAW_TEXT_BOX_GLYPHS,
		DEBUG_DRAW_TEXT_BOX_LAYOUT_BOUNDS,
		DEBUG_DRAW_TEXT_BOX_LIMITS,
		DEBUG_DRAW_TEXT_BOX_LINES_GLYPH_BOUNDS,
		DEBUG_DRAW_TEXT_BOX_LINES_LAYOUT_BOUNDS,
