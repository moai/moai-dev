...
void AKUGfxVKContextInitialize () {
	...
	REGISTER_LUA_CLASS_WITH_ALIAS ( MOAIGfxScriptVK,	"MOAIGfxScript" )
	...
	REGISTER_LUA_CLASS_WITH_ALIAS ( MOAIRenderBatchVK,			"MOAIRenderBatch" )
	REGISTER_LUA_CLASS_WITH_ALIAS ( MOAIShaderVK, 				"MOAIShader" )
