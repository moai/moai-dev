...
int MOAITstoreGamecenterAndroid::_authTstore ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
		...
		ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find java class %s", "com/ziplinegames/moai/MoaiTstoreGamecenter" );
    } else {

    	jmethodID authTstore = env->GetStaticMethodID ( tstore, "authTstore", "(Z)V" );
    	if ( authTstore == NULL ) {

			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "authTstore" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_checkTstoreInstalled ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( checkTstoreInstalled == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "checkTstoreInstalled" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_disableGamecenter ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( disableGamecenter == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "disableGamecenter" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_enableGamecenter ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( enableGamecenter == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "enableGamecenter" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_getRankList ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( getRankList == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "getRankList" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_getUserInfo ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( getUserInfo == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "getUserInfo" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_installGamecenter ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( installGamecenter == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "installGamecenter" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_installTstore ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( installTstore == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "installTstore" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_invokeTstoreJoinPage ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( invokeTstoreJoinPage == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "invokeTstoreJoinPage" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_openGallery ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( invokeGallery == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "invokeGallery" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_setPoint ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( setPoint == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "setPoint" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_setUserInfo ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( setUserInfo == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "setUserInfo" );
    	} else {
...
int MOAITstoreGamecenterAndroid::_startGamecenter ( lua_State* L ) {
    ...
    if ( tstore == NULL ) {
    	...
    	if ( startGamecenter == NULL ) {
			...
			ZLLog::Get ().LogF ( 1, ZLLog::CONSOLE, "MOAITstoreGamecenterAndroid: Unable to find static java method %s", "startGamecenter" );
    	} else {
