...
int MOAINotificationsAndroid::_localNotificationInSeconds ( lua_State* L ) {
    ...
    if ( moai == NULL ) {
    	...
    	if ( localNotificationInSeconds == NULL ) {
			...
			ZLLog::LogF ( 1, ZLLog::CONSOLE, "MOAINotificationsAndroid: Unable to find static java method %s", "localNotificationInSeconds" );
    	} else {
...
int MOAINotificationsAndroid::_registerForRemoteNotifications ( lua_State* L ) {
    ...
    if ( push == NULL ) {
    	...
    	if ( registerForRemoteNotifications == NULL ) {
			...
			ZLLog::LogF ( 1, ZLLog::CONSOLE, "MOAINotificationsAndroid: Unable to find static java method %s", "registerForRemoteNotifications" );
    	} else {
...
int MOAINotificationsAndroid::_unregisterForRemoteNotifications ( lua_State* L ) {
    ...
    if ( push == NULL ) {
    	...
    	if ( unregisterForRemoteNotifications == NULL ) {
			...
			ZLLog::LogF ( 1, ZLLog::CONSOLE, "MOAINotificationsAndroid: Unable to find static java method %s", "unregisterForRemoteNotifications" );
    	} else {
