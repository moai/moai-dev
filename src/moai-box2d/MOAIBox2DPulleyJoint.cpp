...
MOAIBox2DPulleyJoint::MOAIBox2DPulleyJoint () {
	...
	MOAI_LUA_OBJECT_RTTI_BEGIN ( MOAIBox2DPulleyJoint )
...
//----------------------------------------------------------------//
void MOAIBox2DPulleyJoint::MOAILuaObject_RegisterLuaClass ( RTTIVisitorHistory& history, MOAILuaState& state ) {
	if ( history.DidVisit ( *this )) return;
}

//----------------------------------------------------------------//
void MOAIBox2DPulleyJoint::MOAILuaObject_RegisterLuaFuncs ( RTTIVisitorHistory& history, MOAILuaState& state ) {
	if ( history.DidVisit ( *this )) return;
