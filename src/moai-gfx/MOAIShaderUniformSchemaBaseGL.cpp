...
//----------------------------------------------------------------//
bool MOAIShaderUniformSchemaBaseGL::ApplyAttrOp ( void* buffer, ZLAttrID attrID, ZLAttribute& attr, u32 op ) const {
	
	ZLShaderUniformHandleGL uniform = this->GetUniformHandleForAttributeID ( buffer, attrID );
...
//----------------------------------------------------------------//
MOAIShaderUniformSchemaBaseGL::MOAIShaderUniformSchemaBaseGL () {
}
...
//----------------------------------------------------------------//
void MOAIShaderUniformSchemaBaseGL::SetUniform ( lua_State* L, int idx, void* buffer, ZLIndex uniformID, ZLIndex index ) const {

	MOAILuaState state ( L );

	ZLShaderUniformHandleGL uniform = this->GetUniformHandle ( buffer, uniformID, index );
