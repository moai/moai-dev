...
#include <moai-gfx/shaders/MOAIDeck2DShader-fsh.h>
#include <moai-gfx/shaders/MOAIDeck2DShader-vsh.h>
#include <moai-gfx/shaders/MOAIDeck2DSnappingShader-fsh.h>
#include <moai-gfx/shaders/MOAIDeck2DSnappingShader-vsh.h>
#include <moai-gfx/shaders/MOAIDeck2DTexOnlyShader-fsh.h>
#include <moai-gfx/shaders/MOAIDeck2DTexOnlyShader-vsh.h>
#include <moai-gfx/shaders/MOAIFontShader-fsh.h>
#include <moai-gfx/shaders/MOAIFontShader-vsh.h>
#include <moai-gfx/shaders/MOAIFontSnappingShader-fsh.h>
#include <moai-gfx/shaders/MOAIFontSnappingShader-vsh.h>
#include <moai-gfx/shaders/MOAILineShader-fsh.h>
#include <moai-gfx/shaders/MOAILineShader-vsh.h>
#include <moai-gfx/shaders/MOAILineShader3D-fsh.h>
#include <moai-gfx/shaders/MOAILineShader3D-vsh.h>
#include <moai-gfx/shaders/MOAIMeshShader-fsh.h>
#include <moai-gfx/shaders/MOAIMeshShader-vsh.h>
		...
		if ( !program ) {
			...
			switch ( shaderID ) {
				...
				case DECK2D_SNAPPING_SHADER:
					...
					program->DeclareUniform ( ZLIndexCast ( 0 ), "xSnap", ZLShaderUniform::UNIFORM_TYPE_FLOAT );
					program->DeclareUniform ( ZLIndexCast ( 1 ), "ySnap", ZLShaderUniform::UNIFORM_TYPE_FLOAT );
					
					program->ReserveGlobals ( 2 );
					program->SetGlobal ( ZLIndexCast ( 0 ), ZLGfxMgrGL::VIEW_HALF_WIDTH, ZLIndexCast ( 0 ), ZLIndexCast ( 0 ));
					program->SetGlobal ( ZLIndexCast ( 1 ), ZLGfxMgrGL::VIEW_HALF_HEIGHT, ZLIndexCast ( 1 ), ZLIndexCast ( 0 ));
				...
				case LINE_SHADER_3D:
					...
					program->ReserveUniforms ( 2 );
					program->DeclareUniform ( ZLIndexCast ( 0 ), "transform", ZLShaderUniform::UNIFORM_TYPE_FLOAT, ZLShaderUniform::UNIFORM_WIDTH_MATRIX_4X4 );
					program->DeclareUniform ( ZLIndexCast ( 1 ), "ucolor", ZLShaderUniform::UNIFORM_TYPE_FLOAT, ZLShaderUniform::UNIFORM_WIDTH_VEC_4 );
					
					program->ReserveGlobals ( 2 );
					program->SetGlobal ( ZLIndexCast ( 0 ), ZLGfxMgrGL::MODEL_TO_CLIP_MTX, ZLIndexCast ( 0 ), ZLIndexCast ( 0 ));
					program->SetGlobal ( ZLIndexCast ( 1 ), ZLGfxMgrGL::PEN_COLOR, ZLIndexCast ( 1 ), ZLIndexCast ( 0 ));
...
//----------------------------------------------------------------//
MOAIShader* MOAIShaderMgr::GetShader ( lua_State* L, int idx ) {

	MOAILuaState state ( L );
	MOAIShader* shader = NULL;

	if ( state.IsType ( idx, LUA_TNUMBER )) {
		shader = this->GetShader ( state.GetValue < u32 >( idx, MOAIShaderMgr::UNKNOWN_SHADER ));
	}
	else {
