		...
		if ( !program ) {
			...
			switch ( shaderID ) {
				...
				case DECK2D_SNAPPING_SHADER:
					...
					program->DeclareUniform ( ZLIndexCast ( 0 ), "xSnap", ZLShaderUniformGL::UNIFORM_TYPE_FLOAT );
					program->DeclareUniform ( ZLIndexCast ( 1 ), "ySnap", ZLShaderUniformGL::UNIFORM_TYPE_FLOAT );
				...
				case LINE_SHADER_3D:
					...
					program->ReserveUniforms ( 2 );
					program->DeclareUniform ( ZLIndexCast ( 0 ), "transform", ZLShaderUniformGL::UNIFORM_TYPE_FLOAT, ZLShaderUniformGL::UNIFORM_WIDTH_MATRIX_4X4 );
					program->DeclareUniform ( ZLIndexCast ( 1 ), "ucolor", ZLShaderUniformGL::UNIFORM_TYPE_FLOAT, ZLShaderUniformGL::UNIFORM_WIDTH_VEC_4 );
