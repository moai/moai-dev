...
extern void		zglClearColor			( real r, real g, real b, real a );
extern void		zglColor				( real r, real g, real b, real a );
...
extern void		zglLineWidth			( real width );
extern void		zglLoadIdentity			();
extern void		zglLoadMatrix			( const real* matrix );
extern void		zglMatrixMode			( u32 mode );
extern void		zglMultMatrix			( const real* matrix );
extern void		zglPointSize			( real size );
...
extern void		zglUniform1f					( u32 location, real v0 );
extern void		zglUniform1i					( u32 location, s32 v0 );
extern void		zglUniform4fv					( u32 location, u32 count, const real* value );
extern void		zglUniformMatrix3fv				( u32 location, u32 count, bool transpose, const real* value );
extern void		zglUniformMatrix4fv				( u32 location, u32 count, bool transpose, const real* value );
