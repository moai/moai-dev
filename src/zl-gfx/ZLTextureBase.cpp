...
//----------------------------------------------------------------//
void ZLTextureBase::CheckFilterModes ( int min, int mag ) {
	UNUSED ( min );
	UNUSED ( mag );
...
//----------------------------------------------------------------//
void ZLTextureBase::CleanupOnError () {
...
//----------------------------------------------------------------//
bool ZLTextureBase::CreateTextureFromImage ( ZLImage& srcImage ) {
...
//----------------------------------------------------------------//
u32 ZLTextureBase::GetHeight () {
	return this->mHeight;
}

//----------------------------------------------------------------//
u32 ZLTextureBase::GetWidth () {
	return this->mWidth;
}

//----------------------------------------------------------------//
void ZLTextureBase::SetFilter ( int filter ) {

	this->SetFilter ( filter, filter );
}

//----------------------------------------------------------------//
void ZLTextureBase::SetFilter ( int min, int mag ) {
...
//----------------------------------------------------------------//
void ZLTextureBase::SetGLTexture ( const ZLGfxHandle& glTexture, int internalFormat, int pixelType, size_t textureSize ) {
...
//----------------------------------------------------------------//
void ZLTextureBase::SetWrap ( int wrap ) {
...
//----------------------------------------------------------------//
bool ZLTextureBase::ShouldGenerateMipmaps () {
...
//----------------------------------------------------------------//
bool ZLTextureBase::UpdateTextureFromImage ( ZLImage& image, ZLIntRect rect ) {
...
//----------------------------------------------------------------//
bool ZLTextureBase::ZLAbstractGfxResource_OnCPUCreate () {

	return true;
}

//----------------------------------------------------------------//
void ZLTextureBase::ZLAbstractGfxResource_OnCPUDestroy () {
}

//----------------------------------------------------------------//
void ZLTextureBase::ZLAbstractGfxResource_OnGPUBind () {

	this->mGfxMgr->GetDrawingAPI ().BindTexture ( this->mGLTexture );
}

//----------------------------------------------------------------//
void ZLTextureBase::ZLAbstractGfxResource_OnGPUDeleteOrDiscard ( bool shouldDelete ) {
...
//----------------------------------------------------------------//
void ZLTextureBase::ZLAbstractGfxResource_OnGPUUnbind () {

	this->mGfxMgr->GetDrawingAPI ().BindTexture ( ZLGfxResource::UNBIND );
}

//----------------------------------------------------------------//
bool ZLTextureBase::ZLAbstractGfxResource_OnGPUUpdate () {
...
//----------------------------------------------------------------//
void ZLTextureBase::ZLGfxListener_OnGfxEvent ( u32 event, void* userdata ) {
