...
#include <zl-gfx/ZLFrameBufferTexture.h>
...
//----------------------------------------------------------------//
void ZLFrameBufferTexture::Init ( u32 width, u32 height, u32 colorFormat, u32 depthFormat, u32 stencilFormat ) {
...
//----------------------------------------------------------------//
ZLFrameBufferTexture::ZLFrameBufferTexture () :
	mColorFormat ( 0 ),
	mDepthFormat ( 0 ),
	mStencilFormat ( 0 ) {
	
	RTTI_BEGIN
		RTTI_EXTEND ( ZLFrameBuffer )
		RTTI_EXTEND ( ZLTexture )
	RTTI_END
 
	this->mDebugName = "(texture from ZLFrameBufferTexture)";
}
...
//----------------------------------------------------------------//
bool ZLFrameBufferTexture::ZLAbstractGfxResource_OnGPUCreate () {
...
//----------------------------------------------------------------//
void ZLFrameBufferTexture::ZLAbstractGfxResource_OnGPUDeleteOrDiscard ( bool shouldDelete ) {
	...
	this->ZLTexture::ZLAbstractGfxResource_OnGPUDeleteOrDiscard ( shouldDelete );
}

//----------------------------------------------------------------//
void ZLFrameBufferTexture::ZLFrameBuffer_AffirmBuffers () {
