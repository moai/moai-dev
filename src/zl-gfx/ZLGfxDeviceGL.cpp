...
//----------------------------------------------------------------//
u32 ZLGfxDeviceGL::GetCap ( u32 cap ) {
...
//----------------------------------------------------------------//
cc8* ZLGfxDeviceGL::GetErrorString ( u32 error ) {
...
//----------------------------------------------------------------//
cc8* ZLGfxDeviceGL::GetString ( u32 stringID ) {
...
void ZLGfxDeviceGL::Initialize () {
	...
	STLString version = ZLGfxDeviceGL::GetString ( ZGL_STRING_VERSION );
