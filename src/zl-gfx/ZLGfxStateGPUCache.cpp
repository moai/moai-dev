...
//----------------------------------------------------------------//
void ZLGfxStateGPUCache::FlushShader ( ZLShader* shader ) {
	...
	ZLShaderProgram* program = shader ? shader->GetProgram () : 0;
...
void ZLGfxStateGPUCache::FlushVertexBuffer ( ZLVertexBuffer* buffer ) {
	...
	ZLVertexFormat* format = active.mVtxFormat;
...
//----------------------------------------------------------------//
void ZLGfxStateGPUCache::FlushVertexFormat ( ZLVertexFormat* vtxFormat ) {
