...
#ifndef	ZLABSTRACTGFXRESOURCEGL_H
#define	ZLABSTRACTGFXRESOURCEGL_H
...
protected:
	...
	ZLLeanLink < ZLAbstractGfxResourceGL* > mMasterLink;
	ZLLeanLink < ZLAbstractGfxResourceGL* > mPendingLink;
...
public:
	...
	void			SetGfxMgr					( ZLGfxMgrGL& gfxMgr );
					ZLAbstractGfxResourceGL		();
	virtual			~ZLAbstractGfxResourceGL		();
};
