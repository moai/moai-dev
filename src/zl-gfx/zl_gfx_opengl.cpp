...
GLenum _remapEnum ( u32 zglEnum ) {
	...
	switch ( zglEnum ) {
	  ...
	  case ZGL_BLEND_FACTOR_DST_ALPHA:				return GL_DST_ALPHA;
		...
		#ifdef MOAI_OS_IPHONE
			case ZGL_PIXEL_FORMAT_COMPRESSED_RGB_PVRTC_2BPPV1_IMG:	return GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
			case ZGL_PIXEL_FORMAT_COMPRESSED_RGB_PVRTC_4BPPV1_IMG:	return GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
			case ZGL_PIXEL_FORMAT_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG:	return GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
			case ZGL_PIXEL_FORMAT_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG:	return GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
		#endif

		#ifdef MOAI_OS_ANDROID
			case ZGL_PIXEL_FORMAT_ETC1_RGB8_OES:			return GL_ETC1_RGB8_OES;
		#endif
