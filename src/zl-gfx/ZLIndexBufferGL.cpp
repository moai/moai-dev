...
//----------------------------------------------------------------//
u32 ZLIndexBufferGL::CountIndices () {

	return this->GetLength () / this->mIndexSize;
}

//----------------------------------------------------------------//
void ZLIndexBufferGL::CopyFromStream ( ZLStream& stream, size_t size, u32 srcInputSizeInBytes ) {
...
//----------------------------------------------------------------//
u32 ZLIndexBufferGL::GetIndex ( u32 element ) {
...
//----------------------------------------------------------------//
void ZLIndexBufferGL::PrintIndices () {
...
//----------------------------------------------------------------//
void ZLIndexBufferGL::SetIndexSize ( u32 idxSize ) {
...
//----------------------------------------------------------------//
void ZLIndexBufferGL::WriteIndex ( u32 index ) {
...
//----------------------------------------------------------------//
ZLIndexBufferGL::ZLIndexBufferGL () :
	mIndexSize ( 2 ) {
