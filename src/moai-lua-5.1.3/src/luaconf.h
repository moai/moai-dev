...
#define lua_tmpnam(b,e)		{ e = (zipfs_tmpnam(b) == NULL); }
#endif
...
#define lua_popen(L,c,m)	((void)L, zipfs_fflush(NULL), popen(c,m))
...
#define lua_popen(L,c,m)	((void)((void)c, m),  \
		luaL_error(L, LUA_QL("popen") " not supported"), (ZIPFSFILE*)0)
