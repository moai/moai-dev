...
using DockPanelSuite.Properties;
	...
	internal class VS2005DockPaneStrip : DockPaneStripBase
	{
		...
		private static string ToolTipClose
		{
			...
			{	
				...
				//	// DHACK: _toolTipClose = DockPanelSuite.Properties.Resources.DockPaneStrip_ToolTipClose;
		...
		private static string ToolTipSelect
		{
			...
			{	
                ...
                //    // DHACK: _toolTipSelect = DockPanelSuite.Properties.Resources.DockPaneStrip_ToolTipWindowList;
		...
		public VS2005DockPaneStrip(DockPane pane) : base(pane)
		{
            ...
            m_selectMenu.Font = Font; // PluginCore.PluginBase.Settings.DefaultFont;
        ...
        private void ContextMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (item != null)
            {
                ...
                DockPane.ActiveTab = content;
                DockPane.DockPanel.OnTabContentChanged(EventArgs.Empty);
            }
		}
		...
		private void Close_Click(object sender, EventArgs e)
		{
            ...
            DockPane.ActiveTab = DockPane.ActiveContent;
        ...
        // DHACK: middle click document closing
