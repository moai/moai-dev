    ...
    partial class DockPanel
    {
        private static class Persistor
        {
            ...
            public static void SaveAsXml(DockPanel dockPanel, Stream stream, Encoding encoding, bool upstream)
            {
                ...
                xmlOut.WriteComment(DockPanelSuite.Properties.Resources.DockPanel_Persistor_XmlFileComment1);
                xmlOut.WriteComment(DockPanelSuite.Properties.Resources.DockPanel_Persistor_XmlFileComment2);
            ...
            public static void LoadFromXml(DockPanel dockPanel, Stream stream, DeserializeDockContent deserializeContent, bool closeStream)
            {
                ...
                if (dockPanel.Contents.Count != 0)
                    throw new InvalidOperationException(DockPanelSuite.Properties.Resources.DockPanel_LoadFromXml_AlreadyInitialized);
                ...
                if (!IsFormatVersionValid(formatVersion))
                    throw new ArgumentException(DockPanelSuite.Properties.Resources.DockPanel_LoadFromXml_InvalidFormatVersion);
