...
namespace DockPanelSuite
{
    ...
    partial class DockPanel
    {
        private interface IFocusManager
        {
            ...
            IDockContent ActiveTab { get; set; }
        ...
        private class FocusManagerImpl : Component, IContentFocusManager, IFocusManager
        {
            ...
            public void Activate(IDockContent content)
            {
                ...
                if (!handler.Form.ContainsFocus)
                {
                    ...
                    // DHACK: This isn't working so good.  doesn't matter because we do our own focusing. -NICK
        ...
        public IDockContent ActiveTab
        {
            get { return FocusManager.ActiveTab; }
            set { FocusManager.ActiveTab = value; }
        }
        ...
        private static readonly object ActiveTabChangedEvent = new object();
        [LocalizedCategory("Category_PropertyChanged")]
        [LocalizedDescription("DockPanel_ActiveTabChanged_Description")]
        public event EventHandler ActiveTabChanged
        {
            add { Events.AddHandler(ActiveTabChangedEvent, value); }
            remove { Events.RemoveHandler(ActiveTabChangedEvent, value); }
        }
        public void OnTabContentChanged(EventArgs e)
        {
            EventHandler handler = (EventHandler)Events[ActiveTabChangedEvent];
            if (handler != null)
                handler(this, e);
        }
