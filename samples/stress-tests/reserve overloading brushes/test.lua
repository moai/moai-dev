...
curve:reserveKeys ( 9 )
curve:setKey ( 1, 0, 0, MOAIEaseType.FLAT )
curve:setKey ( 2, 0.5, 1, MOAIEaseType.FLAT )
curve:setKey ( 3, 1, 2, MOAIEaseType.FLAT )
curve:setKey ( 4, 1.5, 3, MOAIEaseType.FLAT )
curve:setKey ( 5, 2, 4, MOAIEaseType.FLAT )
