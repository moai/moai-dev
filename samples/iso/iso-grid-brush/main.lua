...
p1 = makeBrushProp ( 0, 0 )
p2 = makeBrushProp ( 271.5, 0 )
p3 = makeBrushProp ( 0, 271.5 )

hero = makeMeshProp ( makeBox ( 45.25, 45.25, 90.5, 'moai.png' ))
hero:setLoc ( 135.75, 135.75 )
layer:insertProp ( hero )

runHero ( hero, p1, p2, p3 )