...
recorder = MOAIFileStream.new ()
MOAIInputMgr.setRecorder ( recorder )

if MOAIFileSystem.checkFileExists ( INPUT_FILENAME ) then
	recorder:open ( INPUT_FILENAME, MOAIFileStream.READ )
	MOAIInputMgr.playback ()
else
	recorder:open ( INPUT_FILENAME, MOAIFileStream.READ_WRITE_NEW )
end
