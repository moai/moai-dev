...
root:setTraitSource ( color, MOAITraits.INHERIT_COLOR )
...
prop:setLoc ( 0.5, 0.5 )
prop:setTraitSource ( root, MOAITraits.INHERIT_LOC + MOAITraits.INHERIT_PARTITION + MOAITraits.INHERIT_COLOR )

prop = MOAIProp2D.new ()
prop:setDeck ( gfxQuad )
prop:setFrame ( -0.25, -0.25, 0.25, 0.25 )
prop:setLoc ( -0.5, -0.5 )
prop:setTraitSource ( root, MOAITraits.INHERIT_TRANSFORM + MOAITraits.INHERIT_PARTITION )
